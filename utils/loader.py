...
class DataLoader(object):
    ...
    """
    def __init__(self, train_file, test_file, opt, word_map, rel_map):
    ...
    def load_from_file(self, file_name, end_str, word_map, rel_map, limit, with_rel, \
                       pos_min_e1, pos_max_e1, pos_min_e2, pos_max_e2):
